...
export const Checkout = () => {
    ...
    const consultarFormulario = (e) => {
        ...
        createOrdenCompra(cliente, aux, totalPrice(), new Date().toISOString()).then(ordenCompra =>{
            toast.success(`¡Gracias, vuelva prontos!, su orden de compra con el ID: ${ordenCompra.id
            } por un total de $ ${new Intl.NumberFormat('de-DE').format(totalPrice())} fue generada con exito`)
            emptyCart()
            e.target.reset()
            navigate("/")
        })
